...
let text = data.data[0].value_classification;


document.getElementById("fear-value").innerHTML =
value;


document.getElementById("fear-text").innerHTML =
text;
...
document.getElementById("fear-value").style.color="red";

}

else if(value > 60){

document.getElementById("fear-value").style.color="green";

}

else{

document.getElementById("fear-value").style.color="orange";
